...
| **Virtualización** | Crear máquinas virtuales en un equipo | `VirtualBox, VMware` | *Uso de varios sistemas en un solo PC y optimización de recursos* |
| **Cloud Computing** | Servicios y almacenamiento en Internet | `Google Drive, OneDrive` | *Acceso remoto y colaboración sin hardware local* |
| **IoT (Internet of Things)** | Dispositivos conectados entre sí | `Arduino, ESP32` | *Automatización y control remoto* |
| **Almacenamiento moderno** | Uso de tecnologías más rápidas | `SSD, NVMe` | *Mayor velocidad y fiabilidad* |
| **Seguridad informática** | Protección de sistemas y datos frente a amenazas | `Antivirus, firewall, cifrado` | *Prevención de ataques y pérdida de datos* |
