...
|-------------------|-------------|----------------------------|----------------------|
| **P-Cores** (Performance) | Núcleso de Rendimiento) | • Núcleos grandes físicamente<br>• Mayor velocidad de reloj<br>• Mayor consumo energético<br>• Soporta Hyper-Threading (2 hilos/núcleo)<br>• Caché L2 independiente por núcleo | • Videojuegos<br>• Aplicaciones CAD<br>• Edición profesional (foto/vídeo)<br>• Tareas de alta exigencia computacional |
