...
3. [Conceptos técnicos previos](#3-conceptos-técnicos-previos)
   - [3.1 BIOS vs UEFI](#31-bios-vs-uefi)
   - [3.2 GPT vs MBR](#32-gpt-vs-mbr)
4. [Método 1: Media Creation Tool (Procedimiento Oficial)](#4-método-1-media-creation-tool-procedimiento-oficial)
   - [4.1 Descarga](#41-descarga)
   - [4.2 Procedimiento paso a paso](#42-procedimiento-paso-a-paso)
   - [4.3 Qué hace internamente la herramienta](#43-qué-hace-internamente-la-herramienta)
5. [Método 2: ISO + Rufus](#5-método-2-iso--rufus)
   - [5.1 Cuándo usar este método](#51-cuándo-usar-este-método)
   - [5.2 Procedimiento](#52-procedimiento)
6. [Proceso de arranque desde USB](#6-proceso-de-arranque-desde-usb)
7. [Proceso técnico de arranque](#7-proceso-técnico-de-arranque)
   - [7.1 En modo BIOS (Legacy)](#71-en-modo-bios-legacy)
   - [7.2 En modo UEFI](#72-en-modo-uefi)
8. [Verificación del USB creado](#8-verificación-del-usb-creado)
9. [Problemas frecuentes y soluciones](#9-problemas-frecuentes-y-soluciones)
   - [9.1 El USB no aparece en el menú de arranque](#91-el-usb-no-aparece-en-el-menú-de-arranque)
   - [9.2 Error de partición GPT/MBR durante instalación](#92-error-de-partición-gptmbr-durante-instalación)
10. [Buenas prácticas en taller](#10-buenas-prácticas-en-taller)
